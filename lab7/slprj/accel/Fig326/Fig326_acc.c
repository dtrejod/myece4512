...
void mdlOutputs ( SimStruct * S , int_T tid ) { real_T bcd1oxfbyh ; real_T
pr223144k1 ; real_T prbewdpg5l ; real_T k5aj5rpifj ; real_T j1dhccl2er ;
...
tid ) ) { _rtB -> ey1aedl4hv = _rtDW -> l3pp1uxdln ; _rtB -> nitv2rhjze =
_rtDW -> hgnufdtddg ; } _rtB -> n053ccfjfp = ( ( ( _rtDW -> gbgkgxsafq * _rtP
-> P_7 + _rtDW -> gsm5zpqka5 * _rtP -> P_6 ) * _rtP -> P_5 + ( _rtDW ->
gsm5zpqka5 * _rtP -> P_7 - _rtDW -> gbgkgxsafq * _rtP -> P_6 ) * _rtP -> P_4
) * _rtP -> P_1 + _rtP -> P_2 ) * _rtB -> hzzqwpds2j + ( ( ( _rtDW ->
i1siadxfat * _rtP -> P_14 + _rtDW -> ed5zfvmsqz * _rtP -> P_13 ) * _rtP ->
P_12 + ( _rtDW -> ed5zfvmsqz * _rtP -> P_14 - _rtDW -> i1siadxfat * _rtP ->
P_13 ) * _rtP -> P_11 ) * _rtP -> P_8 + _rtP -> P_9 ) * _rtB -> ey1aedl4hv ;
if ( ssIsSpecialSampleHit ( S , 1 , 0 , tid ) ) { _rtB -> akxc4lhsrm = _rtDW
-> ibqcfz2hsd ; } ssCallAccelRunBlock ( S , 7 , 9 , SS_CALL_MDL_OUTPUTS ) ; }
if ( ssIsSampleHit ( S , 1 , tid ) ) { RandSrc_U_D ( & kyqcyh0rck , & _rtP ->
P_18 , 1 , & _rtP -> P_19 , 1 , _rtDW -> iusuifohjm , 1 , 1 ) ; _rtB ->
dm0343dvmh = muDoubleScalarCeil ( kyqcyh0rck ) ; } if ( ssIsSampleHit ( S , 0
, tid ) ) { if ( ssIsSpecialSampleHit ( S , 2 , 0 , tid ) ) { _rtB ->
fsk4syoc1f = _rtDW -> knlr0yhwqq ; } itmnht30kk = ( _rtDW -> phxfqcb203 <
_rtP -> P_24 ) && ( _rtDW -> phxfqcb203 >= 0 ) ? _rtP -> P_22 : 0.0 ; if (
_rtDW -> phxfqcb203 >= _rtP -> P_23 - 1.0 ) { _rtDW -> phxfqcb203 = 0 ; }
else { _rtDW -> phxfqcb203 ++ ; } j1dhccl2er = ( _rtDW -> bd23rqa2xo < _rtP
-> P_28 ) && ( _rtDW -> bd23rqa2xo >= 0 ) ? _rtP -> P_26 : 0.0 ; if ( _rtDW
-> bd23rqa2xo >= _rtP -> P_27 - 1.0 ) { _rtDW -> bd23rqa2xo = 0 ; } else {
_rtDW -> bd23rqa2xo ++ ; } j02d3xwrmr = itmnht30kk + j1dhccl2er ; fzze1m1lro
= ( _rtDW -> jwncj5lzey < _rtP -> P_32 ) && ( _rtDW -> jwncj5lzey >= 0 ) ?
_rtP -> P_30 : 0.0 ; if ( _rtDW -> jwncj5lzey >= _rtP -> P_31 - 1.0 ) { _rtDW
-> jwncj5lzey = 0 ; } else { _rtDW -> jwncj5lzey ++ ; } feh5yola42 =
itmnht30kk + fzze1m1lro ; ouvkq3y043 = j1dhccl2er + fzze1m1lro ; ewc2c43fld =
( _rtDW -> ipd02wr3lj < _rtP -> P_36 ) && ( _rtDW -> ipd02wr3lj >= 0 ) ? _rtP
-> P_34 : 0.0 ; if ( _rtDW -> ipd02wr3lj >= _rtP -> P_35 - 1.0 ) { _rtDW ->
ipd02wr3lj = 0 ; } else { _rtDW -> ipd02wr3lj ++ ; } switch ( ( int32_T )
_rtB -> fsk4syoc1f ) { case 0 : itmnht30kk = _rtB -> a2mmlx31si ; break ;
...
= _rtB -> pyk4g0txh2 ; break ; } if ( ssIsSpecialSampleHit ( S , 1 , 0 , tid
) ) { _rtB -> oqg2f1cpdf = itmnht30kk ; } } if ( ssIsSampleHit ( S , 1 , tid
) ) { itmnht30kk = 0.0 ; j1dhccl2er = 0.0 ; j02d3xwrmr = 0.0 ; _rtDW ->
g2y0oiaaxq [ _rtDW -> jlt4j1ea1r ] = _rtB -> dm0343dvmh ; if ( _rtDW ->
...
-> jlt4j1ea1r ] != _rtB -> oqg2f1cpdf ) { itmnht30kk = 1.0 ; } } } _rtDW ->
h22opaprmm += j1dhccl2er ; _rtDW -> bmhlf0kzcm += itmnht30kk ; if ( _rtDW ->
h22opaprmm > 0.0 ) { j02d3xwrmr = _rtDW -> bmhlf0kzcm / _rtDW -> h22opaprmm ;
} _rtB -> izi1jj13xf [ 0U ] = j02d3xwrmr ; _rtB -> izi1jj13xf [ 1U ] = _rtDW
-> bmhlf0kzcm ; _rtB -> izi1jj13xf [ 2U ] = _rtDW -> h22opaprmm ;
ssCallAccelRunBlock ( S , 7 , 32 , SS_CALL_MDL_OUTPUTS ) ; if ( ssIsSampleHit
( S , 1 , tid ) ) { if ( _rtDW -> f5y2hmgdie == 0 ) { _rtB -> oc00ti0dja =
_rtB -> dm0343dvmh ; } else { _rtB -> oc00ti0dja = _rtDW -> mb23qjo0ed ; } if
( _rtDW -> lijl4veot5 == 0 ) { _rtB -> dhtth2fgiy = _rtB -> dm0343dvmh ; }
else { _rtB -> dhtth2fgiy = _rtDW -> hystmkl4hv ; } if ( _rtDW -> esa5eejvtg
== 0 ) { _rtB -> pqt0y5efbj = _rtB -> dm0343dvmh ; } else { _rtB ->
pqt0y5efbj = _rtDW -> o2laygc4pj ; } if ( _rtDW -> jznz54vwad == 0 ) {
kyqcyh0rck = _rtB -> dm0343dvmh ; } else { kyqcyh0rck = _rtDW -> htm4zhsddn ;
} } kyqcyh0rck += ( _rtP -> P_48 * _rtDW -> iqmttsgpy4 [ 0 ] + _rtP -> P_42 *
_rtDW -> b5xqcwsvpa [ 0 ] ) + _rtP -> P_47 * _rtDW -> ot4zbi2yjr ; if (
ssIsSpecialSampleHit ( S , 2 , 1 , tid ) ) { _rtB -> o0pvkkvado = kyqcyh0rck
; } } if ( ssIsSampleHit ( S , 2 , tid ) ) { { uint32_T iLeft ;
Fig326_acc_BINARYSEARCH_real_T_Near_iL ( & ( iLeft ) , _rtB -> o0pvkkvado ,
_rtP -> P_49 , 15U ) ; _rtB -> dwcygdz1i0 = _rtP -> P_50 [ iLeft ] ; } {
uint32_T iLeft ; Fig326_acc_BINARYSEARCH_real_T_Near_iL ( & ( iLeft ) , _rtB
-> o0pvkkvado , _rtP -> P_51 , 15U ) ; _rtB -> inbiwgnqsp = _rtP -> P_52 [
iLeft ] ; } } if ( ssIsSampleHit ( S , 0 , tid ) ) { if ( _rtDW -> maaf4uejih
!= 0 ) { _rtDW -> gy02vnwilg = muDoubleScalarSin ( _rtP -> P_55 *
ssGetTaskTime ( S , 0 ) ) ; _rtDW -> pmsdeid1mj = muDoubleScalarCos ( _rtP ->
P_55 * ssGetTaskTime ( S , 0 ) ) ; _rtDW -> maaf4uejih = 0 ; } itmnht30kk = (
( _rtDW -> gy02vnwilg * _rtP -> P_59 + _rtDW -> pmsdeid1mj * _rtP -> P_58 ) *
_rtP -> P_57 + ( _rtDW -> pmsdeid1mj * _rtP -> P_59 - _rtDW -> gy02vnwilg *
_rtP -> P_58 ) * _rtP -> P_56 ) * _rtP -> P_53 + _rtP -> P_54 ; RandSrc_GZ_D
( & cigjwaifn1 , & _rtP -> P_60 , 1 , & _rtP -> P_61 , 1 , _rtDW ->
d3jd3vbbrd , 1 , 1 ) ; _rtDW -> dtv05qev3p = muDoubleScalarSqrt ( _rtP ->
P_63 * 0.002 / ( muDoubleScalarPower ( 10.0 , ( _rtP -> P_62 +
...
_rtP -> P_66 * ssGetTaskTime ( S , 0 ) ) ; _rtDW -> locc532n0v =
muDoubleScalarCos ( _rtP -> P_66 * ssGetTaskTime ( S , 0 ) ) ; _rtDW ->
ktd4nh1i1g = 0 ; } cigjwaifn1 *= ( ( _rtDW -> fv2y5zeqpe * _rtP -> P_70 +
_rtDW -> locc532n0v * _rtP -> P_69 ) * _rtP -> P_68 + ( _rtDW -> locc532n0v *
_rtP -> P_70 - _rtDW -> fv2y5zeqpe * _rtP -> P_69 ) * _rtP -> P_67 ) * _rtP
-> P_64 + _rtP -> P_65 ; if ( ssIsSampleHit ( S , 0 , tid ) ) { smplsInteg =
...
ssIsSampleHit ( S , 2 , tid ) ) { bcd1oxfbyh = _rtDW -> pika52konh ; } if (
ssIsSampleHit ( S , 2 , tid ) ) { pr223144k1 = _rtDW -> dibjlvagzj ; } {
uint32_T iLeft ; Fig326_acc_BINARYSEARCH_real_T_Near_iL ( & ( iLeft ) ,
bcd1oxfbyh , _rtP -> P_71 , 3U ) ; prbewdpg5l = _rtP -> P_72 [ iLeft ] ; } {
uint32_T iLeft ; Fig326_acc_BINARYSEARCH_real_T_Near_iL ( & ( iLeft ) ,
pr223144k1 , _rtP -> P_73 , 3U ) ; k5aj5rpifj = _rtP -> P_74 [ iLeft ] ; } {
uint32_T iRowIndex1 , iColumnIndex1 ; Fig326_acc_BINARYSEARCH_real_T_Near_iL
( & ( iRowIndex1 ) , prbewdpg5l , _rtP -> P_75 , 3U ) ;
Fig326_acc_BINARYSEARCH_real_T_Near_iL ( & ( iColumnIndex1 ) , k5aj5rpifj ,
_rtP -> P_76 , 3U ) ; _rtB -> ax3whvapof = _rtP -> P_77 [ iRowIndex1 + 4 *
iColumnIndex1 ] ; } } if ( ssIsSampleHit ( S , 1 , tid ) ) { _rtB ->
i4jaxdehzp = _rtDW -> fpclubnbcq [ 0 ] ; } UNUSED_PARAMETER ( tid ) ; }
static void mdlOutputsTID3 ( SimStruct * S , int_T tid ) { jrxlzum13n * _rtB
; ew4gpdq31k * _rtP ; _rtP = ( ( ew4gpdq31k * ) ssGetDefaultParam ( S ) ) ;
_rtB = ( ( jrxlzum13n * ) _ssGetBlockIO ( S ) ) ; _rtB -> a2mmlx31si = _rtP
-> P_21 ; _rtB -> pyk4g0txh2 = _rtP -> P_38 ; UNUSED_PARAMETER ( tid ) ; }
#define MDL_UPDATE
...
dwcygdz1i0 ; } if ( ssIsSampleHit ( S , 0 , tid ) ) { HoldSine = _rtDW ->
...
l3pp1uxdln = _rtB -> inbiwgnqsp ; _rtDW -> hgnufdtddg = _rtB -> o0pvkkvado ;
} if ( ssIsSampleHit ( S , 1 , tid ) ) { _rtDW -> ibqcfz2hsd = _rtB ->
i4jaxdehzp ; } if ( ssIsSampleHit ( S , 2 , tid ) ) { _rtDW -> knlr0yhwqq =
_rtB -> ax3whvapof ; } if ( ssIsSampleHit ( S , 1 , tid ) ) { if ( _rtDW ->
f5y2hmgdie == 0 ) { _rtDW -> mb23qjo0ed = _rtB -> dm0343dvmh ; } _rtDW ->
f5y2hmgdie ++ ; if ( _rtDW -> f5y2hmgdie == 4 ) { _rtDW -> f5y2hmgdie = 0 ; }
_rtDW -> b5xqcwsvpa [ 0U ] = _rtDW -> b5xqcwsvpa [ 1U ] ; _rtDW -> b5xqcwsvpa
[ 1 ] = _rtB -> oc00ti0dja ; if ( ssIsSampleHit ( S , 1 , tid ) ) { if (
_rtDW -> lijl4veot5 == 0 ) { _rtDW -> hystmkl4hv = _rtB -> dm0343dvmh ; }
_rtDW -> lijl4veot5 ++ ; if ( _rtDW -> lijl4veot5 == 4 ) { _rtDW ->
lijl4veot5 = 0 ; } if ( _rtDW -> esa5eejvtg == 0 ) { _rtDW -> o2laygc4pj =
_rtB -> dm0343dvmh ; } _rtDW -> esa5eejvtg ++ ; if ( _rtDW -> esa5eejvtg == 4
) { _rtDW -> esa5eejvtg = 0 ; } if ( _rtDW -> jznz54vwad == 0 ) { _rtDW ->
htm4zhsddn = _rtB -> dm0343dvmh ; } _rtDW -> jznz54vwad ++ ; if ( _rtDW ->
jznz54vwad == 4 ) { _rtDW -> jznz54vwad = 0 ; } } _rtDW -> ot4zbi2yjr = _rtB
-> pqt0y5efbj ; _rtDW -> iqmttsgpy4 [ 0U ] = _rtDW -> iqmttsgpy4 [ 1U ] ;
_rtDW -> iqmttsgpy4 [ 1U ] = _rtDW -> iqmttsgpy4 [ 2U ] ; _rtDW -> iqmttsgpy4
[ 2 ] = _rtB -> dhtth2fgiy ; _rtDW -> fpclubnbcq [ 0U ] = _rtDW -> fpclubnbcq
[ 1U ] ; _rtDW -> fpclubnbcq [ 1U ] = _rtDW -> fpclubnbcq [ 2U ] ; _rtDW ->
fpclubnbcq [ 2 ] = _rtB -> dm0343dvmh ; } if ( ssIsSampleHit ( S , 0 , tid )
) { HoldSine = _rtDW -> gy02vnwilg ; _rtDW -> gy02vnwilg = _rtDW ->
gy02vnwilg * _rtP -> P_57 + _rtDW -> pmsdeid1mj * _rtP -> P_56 ; _rtDW ->
pmsdeid1mj = _rtDW -> pmsdeid1mj * _rtP -> P_57 - HoldSine * _rtP -> P_56 ;
HoldSine = _rtDW -> fv2y5zeqpe ; _rtDW -> fv2y5zeqpe = _rtDW -> fv2y5zeqpe *
_rtP -> P_68 + _rtDW -> locc532n0v * _rtP -> P_67 ; _rtDW -> locc532n0v =
_rtDW -> locc532n0v * _rtP -> P_68 - HoldSine * _rtP -> P_67 ; }
...
( S , 0 , 924930526U ) ; ssSetChecksumVal ( S , 1 , 1720510608U ) ;
ssSetChecksumVal ( S , 2 , 1712440334U ) ; ssSetChecksumVal ( S , 3 ,
134179624U ) ; { mxArray * slVerStructMat = NULL ; mxArray * slStrMat =
